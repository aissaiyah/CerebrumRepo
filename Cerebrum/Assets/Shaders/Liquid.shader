...
Shader "Unlit/SpecialFX/Liquid"
{
    Properties
    {
        ...
        _ColorBack ("Back Color", Color) = (0.7,1,0.7,0)
...
//ORIGINAL
         ...
         {
           // sample the texture
           fixed4 col = _Tint;//_ColorBack;//tex2D(_MainTex, i.uv) * _Tint;
           // apply fog
           if (i.fillEdge > 0.5)//_FillAmount)
           {
               discard;
           }
...
//		   return facing > 0 ? _FoamColor: _RimColor;//finalResult: topColor;
