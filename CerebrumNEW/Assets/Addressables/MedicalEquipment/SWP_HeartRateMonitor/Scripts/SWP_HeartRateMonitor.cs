...
//		float Pheight;
		...
		if (!EnableRealWave && !Tachycardia)
		{
			...
			//P			
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, ((ScaleAmount * 2f) * BlipMonitorHeightModifier) + randomness * Random.Range(0f, ((ScaleAmount * 1f) * BlipMonitorHeightModifier)) + BlipOffset.y, NewClone.transform.localPosition.z);
			yield return new WaitForSeconds(0.02f);		
			//PR segment (delay)
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, 0f + BlipOffset.y, NewClone.transform.localPosition.z);			
			yield return new WaitForSeconds(0.1f);		
			//Q
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, ((ScaleAmount * -3f) * BlipMonitorHeightModifier) + randomness * -Random.Range(0f, ((ScaleAmount * 1f) * BlipMonitorHeightModifier)) + BlipOffset.y, NewClone.transform.localPosition.z);
			yield return new WaitForSeconds(0.01f);	
			//R	
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, ((ScaleAmount * 10f) * BlipMonitorHeightModifier) + randomness *  + Random.Range(0f, ((ScaleAmount * 2f) * BlipMonitorHeightModifier)) + BlipOffset.y, NewClone.transform.localPosition.z);
			yield return new WaitForSeconds(0.03f);	
			//S	
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, ((ScaleAmount * -5f) * BlipMonitorHeightModifier) + randomness *  - Random.Range(0f, ((ScaleAmount * 10f) * BlipMonitorHeightModifier)) + BlipOffset.y, NewClone.transform.localPosition.z);
			yield return new WaitForSeconds(0.02f);	
			...
			//T		
			NewClone.transform.localPosition = new Vector3(NewClone.transform.localPosition.x, ((ScaleAmount * 3f) * BlipMonitorHeightModifier) + randomness *  + Random.Range(0f, ((ScaleAmount * 2f) * BlipMonitorHeightModifier)) + BlipOffset.y, NewClone.transform.localPosition.z);
