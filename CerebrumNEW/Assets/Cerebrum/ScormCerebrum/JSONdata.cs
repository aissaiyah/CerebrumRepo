...
public class DataJSONEndStage //0
{
	...
	public ContextDataSession context;
...
public class DataJSONScore //11 - only one choice since initialized
{
	public ActorData actor;
	public VerbData verb;
	public ObjectDataScore objectData;
...
[Serializable]
public class ObjectDataScore
{
	public string id;
	public DefinitionScore definition;
}
...
[Serializable]
public class DefinitionScore
{
	public string type;
	public ExtensionResultScore extensions;
}
...
[Serializable]
public class ContextDataPatient
{
	public ExtensionResultScore extensions;
}

[Serializable]
public class ContextDataSession
{
	public ExtensionContextSession extensions;
}
...
[Serializable]
public class ExtensionResultScore
{
	public string patient_name;
}

[Serializable]
public class ExtensionContextSession
{
	public string context_session;
}
