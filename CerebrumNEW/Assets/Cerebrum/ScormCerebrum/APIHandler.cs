...
public class APIHandler : MonoBehaviour
{
	...
	//This is all duplicated from ScormPublishSettings but can't seem to read it from there.
	...
	public ObjectDataScore objectDataScore;
	...
	public ContextDataPatient contextPatient;
	public ContextDataSession contextSession;
	...
	void Start()
	{
		//NOT USED.  Now in ScormHandler.cs
	...
	IEnumerator DoSendAPI()
	{
		...
		switch (typeAPI)
		{
			...
			case 3:
				...
				dataListOptionChose.context = contextSession; //PJD-added for Kai
			...
			case 11:
				...
				dataListScore.objectData = objectDataScore;
				dataListScore.resultScore = resultScore;
				dataListScore.context = contextSession; //PJD-added for Kai
			...
			case 12:
				...
				dataListRaw.context = contextSession; //PJD-added for Kai
...
//			tz = tz.Substring(4, 6);
	...
	void EditJSON(ref string jsonData, bool array)
	{
			...
			jsonData = jsonData.Replace("patient_name", "http://gamestrax.com/extensions/patient");
			jsonData = jsonData.Replace("context_session", "http://gamestrax.com/extensions/session");
