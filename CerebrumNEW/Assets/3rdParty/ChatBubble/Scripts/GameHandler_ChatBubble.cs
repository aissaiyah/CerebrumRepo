...
public class GameHandler_ChatBubble : MonoBehaviour {
    ...
    private void Start() {
        ChatBubble.Create(playerTransform, new Vector3(3, 8), ChatBubble.IconType.None, "Here is some text!");
        ...
        FunctionPeriodic.Create(() => {
            ...
            ChatBubble.IconType[] iconArray = 
                new ChatBubble.IconType[] { ChatBubble.IconType.Patient, ChatBubble.IconType.None, ChatBubble.IconType.Nurse };
